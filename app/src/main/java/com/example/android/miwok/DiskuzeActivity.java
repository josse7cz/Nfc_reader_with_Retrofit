...
public class DiskuzeActivity extends AppCompatActivity {
...
//                    content += "text" + post.getText() + "\n\n";
                ...
                PostAdapter adapter = new PostAdapter(DiskuzeActivity.this, mposts);
    ...
    private void createPost() {
        ...
        call.enqueue(new Callback<Post>() {
            ...
            public void onResponse(Call<Post> call, Response<Post> response) {
                if (!response.isSuccessful()) {
                    //textViewResult.setText("Code" + response.code());
                    Toast.makeText(DiskuzeActivity.this, "Error Code: " + response.code(), LENGTH_SHORT).show();
                    return;
                }
                ...
                Toast.makeText(DiskuzeActivity.this, "Created:" + content, Toast.LENGTH_LONG).show();
                getPosts(null, null);
    ...
    private void updatePost() {
        ...
        call.enqueue(new Callback<Post>() {
            ...
            public void onResponse(Call<Post> call, Response<Post> response) {
                if (!response.isSuccessful()) {
                    //textViewResult.setText("Code: " + response.code());
                    Toast.makeText(DiskuzeActivity.this, "Update, Code: " + response.code(), LENGTH_SHORT).show();
                    return;
                }
                Post postResponse = response.body();
                String content = "";
                ...
                //textViewResult.setText(content);
                getPosts(null, null);
                Toast.makeText(DiskuzeActivity.this, "updated: " + response.code(), Toast.LENGTH_LONG).show();
            }

            @Override
            public void onFailure(Call<Post> call, Throwable t) {
                textViewResult.setText(t.getMessage());
                Toast.makeText(DiskuzeActivity.this, "Fail: " + t.getMessage(), LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void deletePost() {
        ...
        call.enqueue(new Callback<Void>() {
            ...
            public void onResponse(Call<Void> call, Response<Void> response) {
                // textViewResult.setText("Code: " + response.code());
                Toast.makeText(DiskuzeActivity.this, "Code: " + response.code(), LENGTH_SHORT).show();
                getPosts(null, null);
            }
            ...
            public void onFailure(Call<Void> call, Throwable t) {
                //textViewResult.setText(t.getMessage());
                Toast.makeText(DiskuzeActivity.this, "Code: " + t.getMessage(), LENGTH_SHORT).show();
            }
        });
    }
